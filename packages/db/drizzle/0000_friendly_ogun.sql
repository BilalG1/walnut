...
CREATE TABLE "branch_db_roles" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "branch_db_roles_branch_scope_unique" UNIQUE("branch_id","scope_key")
);
--> statement-breakpoint
...
ALTER TABLE "branch_db_roles" ADD CONSTRAINT "branch_db_roles_branch_id_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."branches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "query_events" ADD CONSTRAINT "query_events_branch_id_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."branches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
